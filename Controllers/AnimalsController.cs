    ...
    public class AnimalsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Animal != null ? 
                          ...
                          Problem("Entity set 'VetClinicContext.Animal'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome")] Animal animal)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome")] Animal animal)
        {
            if (id != animal.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'VetClinicContext.Animal'  is null.");
            }
            var animal = await _context.Animal.FindAsync(id);
            if (animal != null)
            {
