...
namespace VetClinicWeb.Controllers
{
    public class AtendimentoesController : Controller
    {
        ...
        public AtendimentoesController(VetClinicContext context)
        {
            _context = context;
        }
        ...
        {
              return _context.Atendimento != null ? 
                          View(await _context.Atendimento.ToListAsync()) :
                          Problem("Entity set 'VetClinicContext.Atendimento'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Phone,Descrição,Data")] Atendimento atendimento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Phone,Descrição,Data")] Atendimento atendimento)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'VetClinicContext.Atendimento'  is null.");
            }
            var atendimento = await _context.Atendimento.FindAsync(id);
            if (atendimento != null)
            {
